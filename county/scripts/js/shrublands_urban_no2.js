...
const colorScale = chroma.scale(['#d6d6ff', '#1d49a8']).domain([0, 0.9]);
...
fetch('data/shrublandsUrbanNO2.json')
...
const grades = [0, 0.25, 0.50, 0.75, 0.9];
const labels = [];
...
div.innerHTML = `<strong>NO2 Sequestration<br>(g/m²)</strong><br>` + labels.join('<br>');
return div;
};
